...
public class TransDemo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("translate", new Locale("zh", "CN")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransDemo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
