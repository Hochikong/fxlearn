...
public class TableSelectionDemo extends JPanel
    ...
    class MyTableModel extends AbstractTableModel {
        ...
        private Object[][] data = {
                {"Kathy", "Smith",
                        "Snowboarding", new Integer(5), new Double(12.3), new Boolean(false)},
                {"John", "Doe",
                        "Rowing", new Integer(3), new Double(13.4), new Boolean(true)},
                {"Sue", "Black",
                        "Knitting", new Integer(2), new Double(6.3), new Boolean(false)},
                {"Jane", "White",
                        "Speed reading", new Integer(20), new Double(23.0121), new Boolean(true)},
                {"Joe", "Brown",
                        "Pool", new Integer(10), new Double(934.012), new Boolean(false)}
        };
        ...
        /*
         * When you change a value of the table, fireTableXXXX will be called
         */
        @Override
        public void fireTableCellUpdated(int row, int column) {
            Object nV = getValueAt(row, column);
            System.out.println("New value is" + nV);
        }
    }
